...
class Order{
         ...
         this.itemsObj[i] = 
            {
               ...
               order_item_id: `${obj.orderId}${obj.Items[i].itemId}`,
            }
         
      }
      console.log("hellowoosdf");
   ...
   save(){
      ...
      for(let i = 0; i < this.orderInfo.total_item; i++){
         let itemInfo_sql = `
